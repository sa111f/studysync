...
public class AiTaskParserService {
    ...
    private String systemPrompt(LocalDate today, ZoneId zone) {
        ...
        return "You extract task information from short student-written text.\n\n"
             ...
             + "Before returning, VERIFY by computing the day-of-week for your chosen dueDate and confirming it matches what the user asked for. If the user said \"Monday\" the dueDate MUST be a Monday.\n\n"
